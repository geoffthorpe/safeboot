...
#HCP_RUN_ENROLL_GENCERT ?= $(HCP_RUN_TOP)/creds/gencert-CA
HCP_RUN_ENROLL_GENCERT_AUTOCREATE ?= yes
HCP_RUN_ENROLL_REALM ?= REALM.EXAMPLE.XYZ
...
HCP_RUN_SWTPM_ENROLL_HOSTNAME ?= host.realm.example.xyz
