...
export HCP_RUN_ENROLL_GENCERT_AUTOCREATE=yes
export HCP_RUN_ENROLL_REALM=REALM.EXAMPLE.XYZ
export HCP_RUN_ATTEST_REMOTE_REPO=git://enrollsvc_repl/enrolldb
export HCP_RUN_ATTEST_UPDATE_TIMER=1
export HCP_RUN_SWTPM_ENROLL_HOSTNAME=host.realm.example.xyz
export HCP_RUN_SWTPM_ENROLL_API=http://enrollsvc_mgmt:5000
...
export HCP_RUN_ENROLL_GENCERT_AUTOCREATE="$HCP_RUN_ENROLL_GENCERT_AUTOCREATE"
...
export HCP_RUN_SWTPM_ENROLL_API="$HCP_RUN_SWTPM_ENROLL_API"
